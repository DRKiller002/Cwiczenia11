    ...
    public void run() {
        ...
        do {
            ...
            if (currentName.compareTo(thread.getName()) != 0) {
                ...
                System.out.println(currentName + " jet wykonywany");
            }
...
class PriorityDemo{
    public static void main(String[] args){
        ...
        System.out.println("Wątek o normalnym priorytecie doliczył do " +mt3.count);
        System.out.println("Wątek o normalnym priorytecie doliczył do " +mt4.count);
        System.out.println("Wątek o normalnym priorytecie doliczył do " +mt5.count);
        }
    }
